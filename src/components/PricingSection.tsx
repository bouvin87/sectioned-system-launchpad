    ...
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="border-2 border-slate-200 hover:border-emerald-200 transition-colors">
            ...
            <CardContent>
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-700">Full platform access</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600" />
          ...
          <Card className="border-2 border-emerald-200 bg-emerald-50 relative">
            ...
            <CardContent>
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600" />
                  <span className="text-slate-700">Checklists module</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600" />
                  <span className="text-slate-700">Deviation tracking</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600" />
                ...
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600" />
                  <span className="text-slate-700">Issue reporting</span>
                </li>
              </ul>
            </CardContent>
          </Card>
